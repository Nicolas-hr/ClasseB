...
CREATE TABLE IF NOT EXISTS `Classe2B`.`Tbl_Group` (
  ...
  `Txt_Image_Group` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `Classe2B`.`Tbl_Email` (
  ...
  INDEX `fk_Tbl_Email_Tbl_User1_idx` (`Id_User` ASC),
  CONSTRAINT `fk_Tbl_Email_Tbl_User1`
    FOREIGN KEY (`Id_User`)
...
CREATE TABLE IF NOT EXISTS `Classe2B`.`Tbl_News` (
  ...
  `Id_User` INT NOT NULL,
  PRIMARY KEY (`Id_News`),
  INDEX `fk_Tbl_News_Tbl_User1_idx` (`Id_User` ASC),
  CONSTRAINT `fk_Tbl_News_Tbl_User1`
    FOREIGN KEY (`Id_User`)
    REFERENCES `Classe2B`.`Tbl_User` (`Id_User`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `Classe2B`.`Tbl_Project` (
  ...
  INDEX `fk_Tbl_Project_Tbl_Group1_idx` (`Id_Group` ASC),
  CONSTRAINT `fk_Tbl_Project_Tbl_Group1`
