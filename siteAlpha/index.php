            ...
            <div class="container">
                ...
                <div class="row-fluid">
                    <div class="span4">
                        <div class="centered service">
                            <div class="circle-border zoom-in">
                                <img class="img-circle" src="https://i-cdn.phonearena.com/images/article/84841-image/Microsoft-Word-Excel-and-PowerPoint-for-Android-updated-with-a-few-new-features.jpg" alt="SQL" />
                            </div>
                            <h3>Suite OFFICE</h3>
                    ...
                    <div class="span4">
                        <div class="centered service">
                            <div class="circle-border zoom-in">
                                <img class="img-circle" src="https://www.sololearn.com/Icons/Courses/1073.png" alt="SQL" />
                            </div>
                            <h3>Python</h3>
                            <p>Excel, Word, Powerpoint</p>
                        </div>
